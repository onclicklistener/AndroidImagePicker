...
package com.davesla.librarycroper;
...
import com.davesla.librarycroper.cropwindow.CropOverlayView;
import com.davesla.librarycroper.cropwindow.edge.Edge;
import com.davesla.librarycroper.util.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
    ...
    public Bitmap getCroppedImage() {
        ...
        final float actualCropX = cropWindowX * scaleFactorWidth<0?0:cropWindowX * scaleFactorWidth;
        final float actualCropY = cropWindowY * scaleFactorHeight<0?0:cropWindowY * scaleFactorHeight;
        final float actualCropWidth = cropWindowWidth * scaleFactorWidth;
        final float actualCropHeight = cropWindowHeight * scaleFactorHeight;

        System.out.println("x:" + actualCropX + " y:" + actualCropY + " width:" + actualCropWidth + " height:" + actualCropHeight);
    ...
    private void init(Context context) {
        ...
        final View v = inflater.inflate(R.layout.croper_image_view, this, true);
